...
func TestTransmitPostPrecompResult(t *testing.T) {
	...
	rnd, err := round.New(grp, nil, rndID, []phase.Phase{p}, responseMap, topology, topology.GetNodeAtIndex(0), batchSize, instance.GetRngStreamGen(), nil, "0.0.0.0", nil, nil, nil, nil)
	if err != nil {
