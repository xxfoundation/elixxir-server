...
//
//	checkStreamIntBuffer(grp, rs.R, round.R, "R", t)
//	checkStreamIntBuffer(grp, rs.U, round.U, "U", t)
//	checkStreamIntBuffer(grp, rs.R, round.R, "Y_R", t)
//	checkStreamIntBuffer(grp, rs.U, round.U, "Y_U", t)
//
//	checkIntBuffer(rs.KeysMsg, batchSize, "KeysMsg", grp.NewInt(1), t)
//	checkIntBuffer(rs.CypherMsg, batchSize, "CypherMsg", grp.NewInt(1), t)
//	checkIntBuffer(rs.KeysAD, batchSize, "KeysAD", grp.NewInt(1), t)
//	checkIntBuffer(rs.CypherAD, batchSize, "CypherAD", grp.NewInt(1), t)
//}
//
//func TestRevealGraph(t *testing.T) {
//	primeString := "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" +
//		"29024E088A67CC74020BBEA63B139B22514A08798E3404DD" +
//		"EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" +
//		"E485B576625E7EC6F44C42E9A637ED6B0BFF5CB6F406B7ED" +
...
//			cryptops.ElGamal(s.Grp, s.R.Get(i), s.Y_R.Get(i), s.CypherPublicKey, KeysMsgExpected.Get(i), CypherMsgExpected.Get(i))
//			//Execute elgamal on the keys for the Associated Data
//			cryptops.ElGamal(s.Grp, s.U.Get(i), s.Y_U.Get(i), s.CypherPublicKey, KeysADExpected.Get(i), CypherADExpected.Get(i))
//
...
//		t.Errorf("preomp.RevealStream.Link: Length of intBuffer %s not correct, "+
...
//
//	if numBad != 0 {
//		t.Errorf("preomp.RevealStream.Link: Ints in %v/%v intBuffer %s intilized incorrectly",
