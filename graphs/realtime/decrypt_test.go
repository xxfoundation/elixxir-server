...
func TestDecryptStream_Link(t *testing.T) {
	...
	stream.Link(grp, batchSize, roundBuffer, rng, streamPool, testReporter)
...
func TestDecryptStream_Input_OutOfGroup(t *testing.T) {
	...
	stream.Link(grp, batchSize, roundBuffer, rng, streamPool, testReport)
...
func TestDecryptStream_Input_NonExistantUser(t *testing.T) {
	...
	if err != services.ErrUserIDTooShort {
	...
	if err2 == services.ErrUserIDTooShort {
...
func TestDecryptStream_Input_SaltLength(t *testing.T) {
	...
	stream.Link(grp, batchSize, roundBuffer, nil, streamPool, rng, reporter)
	...
	if err != services.ErrSaltIncorrectLength {
	...
	if err2 == services.ErrSaltIncorrectLength {
...
func TestDecryptStream_Output(t *testing.T) {
	...
	var rng *fastRNG.StreamGenerator
	reporter := round.NewClientFailureReport(instance.GetID())
	stream.Link(grp, batchSize, roundBuffer, rng, streamPool, reporter)
