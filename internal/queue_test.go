...
func TestResourceQueue_RunOne(t *testing.T) {
	...
	r, err := round.New(myGrp, instance.GetStorage(), roundID, []phase.Phase{p}, responseMap, topology, instance.GetID(), 1, instance.GetRngStreamGen(), nil, "0.0.0.0", nil, nil, nil, nil)
	if err != nil {
