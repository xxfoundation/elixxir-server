...
func (r *Round) GetMeasurements(nid string, numNodes, index int, resourceMonitor measure.ResourceMonitor) measure.RoundMetrics {
	rid := r.GetID()
	...
	rm.SetResourceMetric(resourceMonitor.Get())
