...
// 2021-03-26 21:29:16.069268815 +0000 UTC m=+0.005000262
package cmd

const GITVERSION = `1dc61923 Update polling to only send the most important data instead of the full NDF response packet and extras each time`
const SEMVER = "2.2.6"
